                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name = "position_id" id = "position_id" class = "form-control">
                                    @foreach($positions as $viewPosition)
                                        <option value = "{{ $viewPosition-> id}}">{{$viewPosition->position}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4 text-md-center" style = "margin-bottom: 3%">
